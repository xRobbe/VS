 ...
 * @author debian
 */
public class UDPPowerSimulator {
    ...
    public static void main(String[] args) {
        try {
            UDPPowerSimulator powerSimulator = new UDPPowerSimulator();
            powerSimulator.run();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public UDPPowerSimulator() throws Exception {
        this.host = "localhost";
        this.port = 9997;
        this.sleepTime = 10;
...
//    }
    ...
    public void runThread() throws Exception {
        final UDPPowerSimulator sim = this;
    ...
    public void buildPacketBody() throws Exception {
        ...
        json.put("type", "power");
        json.put("powerconsumtion", simulateValues());
